...
class ExTextFieldNormal extends StatelessWidget {
  const ExTextFieldNormal({
    Key? key,
    this.borderColor = const Color.fromARGB(255, 130, 130, 130),
    this.hint,
    this.tfController,
    this.isPassword,
    this.obscureText,
    ...
    this.validator,
    this.borderColorFocus = Colors.blue,
  ...
  Widget build(BuildContext context) {
    return VStack(
      [
        if (labelText != null) labelText!.text.caption(context).color(labelTextColor).make().pOnly(bottom: 12),
        ExBaseTextField(
