      ...
      return ElevatedButton(
        ...
        child: HStack(
          [
            ...
            '$label'.text.textStyle(TextStyle(color: labelColor, fontWeight: isLabelBold == true ? FontWeight.w900 : FontWeight.normal)).size(labelSize).overflow(TextOverflow.ellipsis).make(),
